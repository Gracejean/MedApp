...
public class HeadacheMed extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Biogesic", "Paracetamol", "For minor aches and etc.",  new Integer(10),  new Integer(50)},
                {"Nalfon", "Fenoprofen", "For mild to moderate pain and etc.",  new Integer(100),  new Integer(40)},
                {"Bioflu", "Penylophrine", "For clogged nose and etc.",  new Integer(20),  new Integer(30)}
            },
            new String [] {
